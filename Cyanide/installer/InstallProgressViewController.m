...
- (void)viewDidLoad
{
    ...
    self.bannerLabel.layer.cornerRadius = 10.0;
    ...
    [NSLayoutConstraint activateConstraints:@[
        [self.bannerLabel.topAnchor constraintEqualToAnchor:self.view.safeAreaLayoutGuide.topAnchor constant:12.0],
        [self.bannerLabel.leadingAnchor constraintEqualToAnchor:self.view.leadingAnchor constant:12.0],
        [self.bannerLabel.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor constant:-12.0],

        [separator.topAnchor constraintEqualToAnchor:self.bannerLabel.bottomAnchor constant:12.0],
