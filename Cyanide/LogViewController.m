...
- (void)viewDidLoad {
    ...
    _bannerLabel.layer.cornerRadius = 10.0;
    ...
    [NSLayoutConstraint activateConstraints:@[
        [_bannerLabel.topAnchor constraintEqualToAnchor:self.view.safeAreaLayoutGuide.topAnchor constant:12.0],
        [_bannerLabel.leadingAnchor constraintEqualToAnchor:self.view.leadingAnchor constant:12.0],
        [_bannerLabel.trailingAnchor constraintEqualToAnchor:self.view.trailingAnchor constant:-12.0],

        [separator.topAnchor constraintEqualToAnchor:_bannerLabel.bottomAnchor constant:12.0],
